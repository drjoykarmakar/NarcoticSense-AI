...
class ProbabilityConformalPredictor:
    ...
    def fit(self, true_labels: list[str], probabilities: list[dict[str, float]]) -> "ProbabilityConformalPredictor":
        scores = [1.0 - probs[label] for label, probs in zip(true_labels, probabilities, strict=True)]
